  ...
  head: () => ({
    meta: [
      ...
      { title: "Stein Premium — Private Cigar Lounge & Business Club" },
      {
        name: "description",
        content:
          "Stein Premium is a private cigar lounge built around premium cigars, exclusive events and meaningful business connections.",
      },
      { name: "author", content: "Stein Premium" },
